        ...
        <View style={{ flex: 1 }}>
            <View style={styles.body}>
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1, paddingHorizontal: 25, }}>
                    ...
                    <TextInput placeholder={'Enter password'} secureTextEntry={true} value={password}
                    ...
                    <Text onPress={() => props?.navigation.navigate('Signup')}
                        style={{ textDecorationLine: 'underline', marginTop: 20,
                         alignSelf: 'center', fontSize: 18, fontWeight: '800' }}>
